...
var (
	...
	ErrRenameOption            = serializer.NewError(serializer.CodeNotFullySuccess, "文件名发生冲突时,未支持的重命名操作", nil)
	ErrUnknownOption           = serializer.NewError(serializer.CodeNotFullySuccess, "未指定冲突解决方案", nil)
